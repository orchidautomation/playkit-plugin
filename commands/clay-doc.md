...
5. Use `clay_get_schema` top-level `prompts`, up to 5 `sample_rows`, source/search config, source columns, and view details before falling back to raw schema traversal or export calls.
